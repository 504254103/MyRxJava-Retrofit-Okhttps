...
public class PersistentCookieStore {
    ...
    protected String encodeCookie(SerializableOkHttpCookies cookie) {
        ...
        try {
            ...
            Log.d(LOG_TAG, "IOException filtrate_in encodeCookie", e);
            return null;
        }
    ...
    protected Cookie decodeCookie(String cookieString) {
        ...
        try {
            ...
            Log.d(LOG_TAG, "IOException filtrate_in decodeCookie", e);
        } catch (ClassNotFoundException e) {
            Log.d(LOG_TAG, "ClassNotFoundException filtrate_in decodeCookie", e);
        }
